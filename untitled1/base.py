...
def timeFun(sched_time):
    ...
    while True:
        ...
        if sched_time < now < sched_time + datetime.timedelta(seconds=1):  # ��Ϊʱ����֮���С�����ֲ�һ����ȣ�Ҫ���һ����Χ�ж�
            send_move()
            time.sleep(1)  # ÿ���жϼ��1s�������δ����¼�
            flag = 1
        else:
            # print('schedual time is {0}'.format(sched_time))
            # print('now is {0}'.format(now))
            if flag == 1:
                sched_time = sched_time + datetime.timedelta(hours=1)  # ��Ŀ��ʱ������һ��Сʱ��һ��Сʱ�󴥷��ٴ�ִ��
                flag = 0


def send_move():
    # nickname = input('please input your firends\' nickname : ' )
    #   ���˭����Ϣ���Ȳ��ҵ��������,name����΢�ű�ע����,deepin���Գɹ�
    # users = itchat.search_friends(name=nickname)
    users = itchat.search_friends(name='Kim')  # ʹ�ñ�ע��������ʵ���û���
    # ��ȡ����ȫ����Ϣ,����һ���б�,�б�����һ���ֵ�
    import pymysql
...
if __name__ == '__main__':
    itchat.auto_login(hotReload=True)  # �״�ɨ���¼������Զ���¼
    sched_time = datetime.datetime(2018, 4, 24, 16, 24, 00)  # �趨���δ����¼����¼���
